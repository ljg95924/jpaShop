...
@Getter
@Setter
@NoArgsConstructor(access = AccessLevel.PROTECTED) // Order 객체 사용 제약(생성 메서드를 사용할때 유용)
public class Order {
    @Id
    @GeneratedValue
    ...
    // Cascade를 사용하면 persist(order)만 해주면 된다. order 만 persist 해줘도 orderItems 를 persist 해줌
